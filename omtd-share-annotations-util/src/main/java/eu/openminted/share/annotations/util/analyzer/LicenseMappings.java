...
public final class LicenseMappings
{
    ...
    static {
        ...
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by/4.0/", CC_BY_4_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nc/4.0/", CC_BY_NC_4_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nc-nd/4.0/", CC_BY_NC_ND_4_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nc-sa/4.0/", CC_BY_NC_SA_4_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nd/4.0/", CC_BY_ND_4_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-sa/4.0/", CC_BY_SA_4_0);
        URL_TO_SPDX.put("https://creativecommons.org/publicdomain/zero/1.0/", CC0_1_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by/3.0/", CC_BY_3_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nc/3.0/", CC_BY_NC_3_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nc-nd/3.0/", CC_BY_NC_ND_3_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nc-sa/3.0/", CC_BY_NC_SA_3_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-nd/3.0/", CC_BY_ND_3_0);
        URL_TO_SPDX.put("https://creativecommons.org/licenses/by-sa/3.0/", CC_BY_SA_3_0);
        URL_TO_SPDX.put("https://opendatacommons.org/licenses/pddl/", PDDL);
        URL_TO_SPDX.put("https://opendatacommons.org/licenses/by/1-0/", ODC_BY_1_0);
        URL_TO_SPDX.put("https://opendatacommons.org/licenses/odbl/1-0/", ODBL_1_0);
        URL_TO_SPDX.put("http://www.affero.org/oagpl.html", AGPL_1_0);
        URL_TO_SPDX.put("http://directory.fsf.org/wiki/License:BSD_4Clause", BSD_4_CLAUSE);
        URL_TO_SPDX.put("https://opensource.org/licenses/BSD-3-Clause", BSD_3_CLAUSE);
        URL_TO_SPDX.put("https://opensource.org/licenses/BSD-2-Clause", BSD_2_CLAUSE);
        URL_TO_SPDX.put("https://www.gnu.org/licenses/fdl-1.3.en.html", GFDL_1_3);
        URL_TO_SPDX.put("https://www.gnu.org/licenses/lgpl-3.0.en.html", LGPL_3_0);
        URL_TO_SPDX.put("https://opensource.org/licenses/MIT", MIT);
        URL_TO_SPDX.put("https://wordnet.princeton.edu/wordnet/license/", PRINCETON_WORD_NET);
        URL_TO_SPDX.put("https://www.eclipse.org/legal/epl-v10.html", LicenceEnum.EPL_1_0);
        URL_TO_SPDX.put("https://www.nlm.nih.gov/databases/license/license.pdf", NLM);
        URL_TO_SPDX.put("https://www.hbz-nrw.de/produkte/open-access/lizenzen/dppl/fdppl/f-DPPL_v3_en_11-2008", F_DPPL_3_0);
        URL_TO_SPDX.put("https://www.hbz-nrw.de/produkte/open-access/lizenzen/dppl/mdppl/m-DPPL_v3_en_11-2008", M_DPPL_3_0);
    }
